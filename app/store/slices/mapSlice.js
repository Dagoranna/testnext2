...
const FORMS_LIST = {
  ...
  "elemForm_8": {
    borderRadius: "50%",
    background: "conic-gradient(black 0deg, darkgray 45deg, black 45deg, darkgray 90deg, black 90deg, darkgray 135deg, black 135deg, darkgray 180deg, black 180deg, darkgray 225deg, black 225deg, darkgray 270deg, black 270deg, darkgray 315deg, black 315deg, darkgray 360deg)",
  },  
  "elemForm_9": {
    borderRadius: "0",
    opacity: "0.5",
...
const mapSlice = createSlice({
  ...
  reducers: {
    ...
    setActivePaletteAction: (state, action) => {state.activePaletteAction = action.payload; },
    ...
    setActivePaletteForm: (state, action) => {state.activePaletteStyle.form = action.payload; },
    switchGridBinding: (state, action) => {state.activePaletteStyle.bindToGrid = !state.activePaletteStyle.bindToGrid},
  }
});
